<?php
				...
				if(!isset($_GET['image'])) {
					...
					foreach($images as $k=>$v) {
						...
						echo "<div style=\"float:left; margin: 20px\" width = \"100\" border = \"1\"><a href=\"index.php?page=gallery&image=$k\"><img src=\"images/$v\" alt =\"$k\" width = \"50\" height = \"50\"/></a><br />$k</div>\n";
					...
					echo "<div><img style=\"float:left; margin: 20px; width; 400px\" src=\"images/$images[$getThis]\" />$captions[$getThis]</div>\n";
